...
static const CGFloat BUBBLE_AVG_RADIUS = 30;
- (IBAction)changeView:(id)sender {
    XZTimetableVC *main = [[XZTimetableVC alloc]init];
...
- (void)viewDidLoad
{
    ...
    for (int i=0; i<[classes count] ; i++) {
        ...
        classInBubbleLabel.font=[UIFont systemFontOfSize:7*(2+bubbleZoomRatio/130)];
        ...
        bubble.lableText = classInBubbleLabel.text;
        ...
        //添加手势
        UITapGestureRecognizer *tapBubble = [[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(tapBubble:)];
...
-(void)tapBubble:(UIGestureRecognizer *)gr{
    BubbleView *bu = (BubbleView *)gr.view;
    XZClassPickerVC *picker = [[XZClassPickerVC alloc]init];
    picker.title = bu.lableText;
